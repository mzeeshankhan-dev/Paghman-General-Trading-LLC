  ...
  return (
    <section className="section-y bg-navy-900 text-white">
      <div className="container-page">
        <SectionHeading eyebrow={t("nav.about")} title={t("home.whyUsTitle")} subtitle={t("home.whyUsSubtitle")} light />
        ...
        <div className="mt-12 grid gap-px overflow-hidden rounded-3xl bg-white/10 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((item, index) => {
            ...
            return (
              <Reveal key={item.title} delay={index * 0.06} className="flex flex-col gap-4 bg-navy-900 p-8 transition-colors hover:bg-navy-800">
                {Icon && (
